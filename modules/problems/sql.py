class SQLStatements:
    ...
    SUBMIT_SOLUTION = "INSERT INTO submissions (user_id, problem_id, submission_code) VALUES (?, ?, ?)"
    ...
    GET_USER_SUBMISSIONS_WITH_PROBLEM_NAME = """
        SELECT s.id, s.problem_id, p.title as problem_name, s.submission_code, s.submission_date
        FROM submissions s
